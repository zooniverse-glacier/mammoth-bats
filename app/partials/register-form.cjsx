...
module.exports = React.createClass
  ...
  checkForNameConflict: (username) ->
    @promiseToSetState nameConflict: @props.auth.register(login: username).catch (error) ->
  ...
  checkForEmailConflict: (email) ->
    @promiseToSetState emailConflict: @props.auth.register({email}).catch (error) ->
  ...
  handleSubmit: (e) ->
    ...
    @setState error: null
    @props.onSubmit?()
    @props.auth.register {login, password, email, credited_name, global_email_communication, project_id, beta_email_communication}
      .then =>
