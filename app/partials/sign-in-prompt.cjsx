...
module.exports = React.createClass
  ...
  signIn: ->
    @props.onChoose()
    alert (resolve) =>
      <LoginDialog which="sign-in" project={@props.project} onSuccess={resolve} auth={@props.auth} />

  register: ->
    @props.onChoose()
    alert (resolve) =>
      <LoginDialog which="register" project={@props.project} onSuccess={resolve} auth={@props.auth} />
